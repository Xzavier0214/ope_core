...
double SphericalFitnessFcn(const double *pIndividual, const double *pK, const double *pStateP0, const double *pStateE0,
    ...
    memcpy(gExtState + 18, pIndividual + 6, g_DOUBLE_2);
    gExtState[20] = pIndividual[2];
    memcpy(gExtState + 21, pIndividual + 8, g_DOUBLE_3);
...
double SolveSpherical(Param *pParam, double *pOptIndividual, bool printProcess) {
...
double SolveCartesian(Param *pParam, double *pOptIndividual, bool printProcess) {
