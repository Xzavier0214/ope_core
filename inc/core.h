...
#ifndef OPE_CORE_CORE_H
#define OPE_CORE_CORE_H
...
struct Param {
    ...
    unsigned int dim;       // 个体维数（Spherical：12，Cartesian：13）
...
constexpr size_t SPHERICAL_INDIVIDUAL_SIZE = 12;
...
//  求解球坐标系
double SolveSpherical(Param *pParam, double *pOptIndividual, bool printProcess=false);

//////////////////////////笛卡尔坐标系//////////////////////////

constexpr size_t CARTESIAN_STATE_SIZE = 6;
constexpr size_t CARTESIAN_CONTROL_SIZE = 2;
constexpr size_t CARTESIAN_EXT_STATE_SIZE = 4*SPHERICAL_STATE_SIZE;
...
//  求解笛卡尔坐标系
double SolveCartesian(Param *pParam, double *pOptIndividual, bool printProcess=false);

#endif //OPE_CORE_CORE_H
